...
import { Home, Users, ShoppingBag, FileText, Settings, LogOut, Menu, X } from "lucide-react"
...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const navItems = profile.role === "manager" ? managerNavItems : startupNavItems
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-lg font-bold text-[#212121]">Orange Corners</span>
            </div>
                  ...
                  <li key={item.href}>
                    <Link
                      ...
                      className={`
                        ...
                        ${isActive ? "bg-[#FF7A00] text-white" : "text-[#212121] hover:bg-[#F9F7F1]"}
                      `}
          ...
          <div className="p-4 border-t border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-[#212121]">{profile.full_name || profile.email}</p>
                <p className="text-xs text-[#212121] opacity-70 capitalize">{profile.role}</p>
              </div>
              <Button variant="ghost" size="sm" onClick={handleLogout} className="text-[#212121] hover:text-[#FF7A00]">
        ...
        <header className="bg-white border-b border-gray-200 px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <span className="text-sm text-[#212121]">Welcome, {profile.full_name || profile.email}</span>
            </div>
          </div>
        </header>
        ...
        <footer className="bg-white border-t border-gray-200 px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm font-medium text-[#212121]">Orange Corners</span>
            </div>
            <p className="text-xs text-[#212121] opacity-70">© 2025 Orange Corners. All Rights Reserved.</p>
            <div className="flex items-center space-x-2">
